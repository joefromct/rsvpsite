...
ALTER TABLE guest_detail ADD FOREIGN KEY (party_id) REFERENCES party (party_id) ON UPDATE NO ACTION ON DELETE NO ACTION;  

ALTER TABLE guest_detail ADD FOREIGN KEY (entree_id) REFERENCES entree (entree_id)     ON UPDATE NO ACTION ON DELETE NO ACTION;  
